<table class="table table-striped- table-bordered table-hover table-checkable nowrap" id="datatableAssetTanah" style="width: 1200px;">
    <thead>
    <tr role="row">
        <th> No </th>
        ...
        $(document).ready(function () {
            var options = {
                ...
                columns: [
                    ...
                    { data: 'kuantitasi', sClass: "text-right" },
                    { data: 'luas_tanah_seluruhnya', sClass: "text-right" },
                    { data: 'luas_tanah_untuk_bangunan', sClass: "text-right" },
                    { data: 'luas_tanah_untuk_sarana', sClass: "text-right" },
                    { data: 'luas_lahan_kosong', sClass: "text-right" },
                    ...
                    { data: 'kecamatan' },
                    { data: 'kabupaten' },
                    { data: 'kode_kabupaten', sClass: "text-center"},
                    { data: 'provinsi' },
                    { data: 'kode_provinsi', sClass: "text-center"},
                    { data: 'kode_pos', sClass: "text-center"},
                    { data: 'alamat_lainnya' },
                    { data: 'jml_kib', sClass: "text-center" },
                    { data: 'sbsk', sClass: "text-right" },
                    { data: 'optimalisasi', sClass: "text-right" },
