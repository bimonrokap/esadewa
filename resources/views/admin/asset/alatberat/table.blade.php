<table class="table table-striped- table-bordered table-hover table-checkable nowrap" id="datatableAssetBerat" style="width: 1200px;">
    <thead>
    <tr role="row">
        <th> No </th>
        ...
        $(document).ready(function () {
            var options = {
                ...
                columns: [
                    ...
                    { data: 'jml_buku', sClass: "text-center" },
