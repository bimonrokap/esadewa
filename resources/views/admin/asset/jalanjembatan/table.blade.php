<table class="table table-striped- table-bordered table-hover table-checkable nowrap" id="datatableJalanJembatan" style="width: 1200px;">
    <thead>
    <tr role="row">
        <th> No </th>
        ...
        $(document).ready(function () {
            var options = {
                ...
                columns: [
                    ...
                    { data: 'luas_dasar', sClass: "text-right" },
