<table class="table table-striped- table-bordered table-hover table-checkable nowrap" id="datatableRenovasi" style="width: 1200px;">
    <thead>
    <tr role="row">
        <th> No </th>
        ...
        $(document).ready(function () {
            var options = {
                ...
                columns: [
                    ...
                    { data: 'kode_kpknl', sClass: "text-center" },
