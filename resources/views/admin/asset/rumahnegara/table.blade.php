<table class="table table-striped- table-bordered table-hover table-checkable nowrap" id="datatableRumahNegara" style="width: 1200px;">
    <thead>
    <tr role="row">
        <th> No </th>
