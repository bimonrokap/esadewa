<table class="table table-striped- table-bordered table-hover table-checkable nowrap" id="datatableAssetAngkutanBermotor" style="width: 1200px;">
    <thead>
    <tr role="row">
        <th> No </th>
...
@push('scripts')
    <script type="text/javascript">
        $(document).ready(function () {
            var options = {
                table: '#datatableAssetAngkutanBermotor',
                url: "{!! $tableRoute !!}",
                order: [ 1, "desc" ],
                columns: [
                    ...
                    { data: 'kode_barang' },
                    { data: 'nup' },
                    { data: 'kode_satker', sClass: "text-center" },
                    { data: 'nama_satker' },
                    ...
                    { data: 'kuantitas', sClass: "text-center" },
                    ...
                    { data: 'no_polisi' },
                    { data: 'pemakai' },
                    { data: 'jumlah_kib', sClass: "text-center" },
