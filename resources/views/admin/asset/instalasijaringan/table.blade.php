<table class="table table-striped- table-bordered table-hover table-checkable nowrap" id="datatableInstalasiJaringan" style="width: 1200px;">
    <thead>
    <tr role="row">
        <th> No </th>
...
@push('scripts')
    <script type="text/javascript">
        $(document).ready(function () {
            var options = {
                table: '#datatableInstalasiJaringan',
                url: "{!! $tableRoute !!}",
                order: [ 1, "desc" ],
                columns: [
