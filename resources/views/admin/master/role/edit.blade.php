                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="m-form__section m-form__section--first">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-4">
                                    <input value="{{ $data->name }}" type="text" class="form-control m-input m-input--solid required" name="name" placeholder="Nama Role" />
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-3">
                                    <select name="id_parent" class="form-control m-input m-input--solid select2 required">
                                        @foreach($roles as $role)
                                            <option {{ $data->id_parent == $role->id ? 'selected="selected"' : '' }} value="{{ $role->id }}">{{ $role->name }}</option>
                                            @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-2">
                                    <input value="{{ $data->level }}" type="text" class="form-control m-input m-input--solid required text-right" name="level" placeholder="Level" />
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-4">
                                    <textarea class="form-control m-input m-input--solid" name="description" placeholder="Deskripsi" rows="5">{{ $data->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
