    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div id="con-head">
                ...
                <form class="m-form" action="{{ route($config['route'] . '.store', ['type' => $type, 'tanah' => $typeTanah]) }}" method="POST" id="form">
                    <input type="hidden" name="tanah_type" value="{{ $typeTanah }}" >
                    <div class="tab-content pt-1">
                                ...
                                <div class="m-portlet__body">
                                    <div class="m-form-custom-5 row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <select id="inputJenisPengadaan" name="jenis_pengadaan" class="form-control m-input select2 required">
                                                    ...
                                                    @foreach($jenisPengadaan as $jenis)
                                                        <option value="{{ $jenis->id }}">Tanah {{ $jenis->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group m-form__group">
                                            ...
                                            <div class="form-group m-form__group">
                                                <label> TOR ditandatangani KPA <span class="required">*</span></label>
                        ...
                        @for($i = 1;$i <= ($typeTanah == 2 ? 1 : 3);$i++)
                        <div class="tab-pane" id="tabPenawaran{{ $i }}" aria-labelledby="baseIcon-tab{{ 5+$i }}">
                            <div class="m-portlet m-portlet--mobile" style="margin-bottom: 0;">
                                <div class="m-portlet__body">
                                    @component('admin.components.usulan.penawaran', ['config' => $config, 'uuid' => $uuid.'-'.$i, 'class' => $i, 'param' => ['type' => 'pengadaan']]) @endcomponent
                                </div>
                            </div>
                        </div>
                        @endfor
