                                    ...
                                    <div class="m-form-custom-5 row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                @if($isRevisi)
                                                    <p class="form-control-static"><a target="_blank" href="{{ \App\Model\Sewa\Sewa::docLocation($data->id, $data->surat_penghantar_banding, true) }}">Surat Pengajuan Satuan Kerja</a></p>
                                                    @endif
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
