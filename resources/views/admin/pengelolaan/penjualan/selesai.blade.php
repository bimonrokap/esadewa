        ...
        <div class="col-xl-12">
            ...
            <div id="con-head">
                <ul class="nav nav-pills nav-custom">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="baseIcon-tab4" data-toggle="tab" aria-controls="tabPersetujuanPenjualan" href="#tabPersetujuanPenjualan" aria-expanded="false"><i class="la la-arrows-alt "></i> Persetujuan Penjualan </a>
                    </li>
                </ul>
                                ...
                                <div class="m-portlet__body">
                                    ...
                                    <div class="m-form-custom-5 row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group m-form__group">
                                                <label> Surat Persetujuan Izin Penjualan <span class="required">*</span> </label>
