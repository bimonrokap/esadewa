<div class="m-form-custom-5 row">
    <div class="col-lg-6">
        ...
        <div class="form-group m-form__group">
            <label> Surat Persetujuan Izin Penjualan </label>
            <p class="form-control-static">
                @include('components.form.fileButton', ['title' => 'Surat Persetujuan Izin Penjualan', 'type' => 'pdf', 'url' => \App\Model\Penjualan\Penjualan::docLocation($data->id, $data->surat_persetujuan, true)])
            </p>
        </div>
    </div>
    <div class="col-lg-6">
