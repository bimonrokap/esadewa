    ...
    <div class="col-lg-6">
        ...
        <div class="form-group m-form__group">
            ...
            <p class="form-control-static">
                @include('components.form.fileButton', ['title' => 'Surat Pengantar Tingkat Banding', 'type' => 'pdf', 'url' => \App\Model\Bongkaran\Bongkaran::docLocation($data->id, $data->surat_penghantar_banding, true)])
            </p>
        </div>
    </div>
    <div class="col-lg-6">
