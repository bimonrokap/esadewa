                                    ...
                                    <div class="m-form-custom-5 row">
                                        <div class="col-lg-6">
                                            <div class="form-group m-form__group">
                                                <label for="inputLetterNumber"> No Surat Persetujuan Permohonan Bongkaran  <span class="required">*</span> </label>
                                                <input type="text" class="form-control m-input required" id="inputLetterNumber" name="letter_number_persetujuan" placeholder="No Surat Persetujuan Permohonan Bongkaran" />
                                            </div>
                                            <div class="form-group m-form__group">
                                                <label for="inputLetterDate"> Tanggal Surat Persetujuan Permohonan Bongkaran  <span class="required">*</span> </label>
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <div class="input-group m-input-group">
                                                    ...
                                                    <input type="text" class="form-control m-input harga required" id="inputNilaiTaksiranBongkaran" name="nilai_taksiran_verif" placeholder="Nilai Taksiran Bongkaran" />
                                                </div>
                                            </div>
                                            <div class="form-group m-form__group">
                                                <label> Surat Persetujuan Permohonan Bongkaran <span class="required">*</span> </label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group m-form__group">
                                                <label for="inputPerihalSurat"> Perihal Surat Persetujuan Permohonan Bongkaran  <span class="required">*</span> </label>
                                            ...
                                            <div class="form-group m-form__group">
                                                ...
                                                <div class="input-group m-input-group">
                                                    ...
                                                    <input type="text" class="form-control m-input harga required" id="inputLuasbangunan" name="luas_bangunan_verif" placeholder="Luas Bangunan yang Dibongkar" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
