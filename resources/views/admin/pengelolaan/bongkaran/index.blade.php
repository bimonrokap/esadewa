        ...
        <div class="col-xl-12">
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable nowrap" id="datatableBongkaran" style="width: 1200px;">
                        <thead>
                        <tr role="row">
                            <th> No </th>
        ...
        $(document).ready(function () {
            ...
            var options = {
                ...
                columns: [
                    ...
                    { data: 'created_at', name: 'bongkaran.created_at', sClass: 'text-center' },
                    { data: 'bongkaranStatus', name: "ps.id", sClass: 'text-center' },
