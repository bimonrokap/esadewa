                                                    ...
                                                    <div class="m-dropdown__content">
                                                        <ul class="m-nav">
                                                            <li class="m-nav__item">
                                                                <a href="{{ route($config['route'] . '.create', 1) }}" class="m-nav__link ajaxify">
                                                            ...
                                                            <li class="m-nav__item">
                                                                <a href="{{ route($config['route'] . '.create', 2) }}" class="m-nav__link ajaxify">
        ...
        $(document).ready(function () {
            ...
            var options = {
                ...
                columns: [
                    ...
                    { data: 'penghapusanStatus', name: "ps.id", sClass: 'text-center' },
