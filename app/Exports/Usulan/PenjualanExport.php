...
class PenjualanExport implements FromCollection, WithEvents
{
    ...
    */
    public function collection()
    {
        ...
        $rows = [
            [null, null, null, null, null, null, 'LAMPIRAN', ':  SURAT SEKRETARIS MAHKAMAH AGUNG - RI'],
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->mergeCells('I9:I'.$totalRowData);
                ...
                $sheet->getColumnDimension('I')->setWidth($this->convertWidth(19.86));
                ...
                foreach (['H', 'I'] as $row) {
                    ...
                    $sheet->getStyle($row."$startData:".$row.($totalRowData+1))->applyFromArray([
                        'alignment' => array(
                            'vertical' => Alignment::VERTICAL_CENTER,
                        )
                    ]);
