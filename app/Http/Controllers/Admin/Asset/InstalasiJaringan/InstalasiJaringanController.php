...
namespace App\Http\Controllers\Admin\Asset\InstalasiJaringan;
...
class InstalasiJaringanController extends AssetController
{

    private $route = 'admin.asset.instalasijaringan';
    private $title = 'Instalasi Jaringan';
    public $tableHeader = ['Kode Barang', 'NUP', 'Kode Satker', 'Nama Satker', 'KIB', 'Nama Barang', 'Kondisi', 'Merk/Tipe', 'Tgl Perolehan', 'Tgl Rekam Pertama', 'Nilai Perolehan Pertama', 'Nilai Mutasi', 'Nilai Perolehan', 'Nilai Penyusutan', 'Nilai Buku', 'Kuantitas', 'Jml Foto', 'Status Penggunaan', 'Status Pengelolaan', 'No PSP', 'Tgl PSP', 'Tanggal Update'];
    protected $categoryAsset = 13;

    public function __construct()
    {
        $this->model = new AssetInstalasiJaringan();
    ...
    public function index()
    {
        ...
        $data['importSlug'] = 'instalasijaringan';
