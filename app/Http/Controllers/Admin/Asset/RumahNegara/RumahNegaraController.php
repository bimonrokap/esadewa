...
namespace App\Http\Controllers\Admin\Asset\RumahNegara;
...
class RumahNegaraController extends AssetController
{

    private $route = 'admin.asset.rumahnegara';
    private $title = 'Rumah Negara';
    public $tableHeader = ['Kode Barang', 'NUP', 'Kode Satker', 'Nama Satker', 'KIB', 'Nama Barang', 'Kondisi', 'Jenis Dokumen', 'Kepemilikan', 'Jenis sertifikat', 'Merk/Tipe', 'Tgl Perolehan', 'Tgl Rekam Pertama', 'Nilai Perolehan Pertama', 'Nilai Mutasi', 'Nilai Perolehan', 'Nilai Penyusutan', 'Nilai Buku', 'Kuantitas', 'Jml Foto', 'Luas Bangunan', 'Luas Dasar Bangunan', 'Alamat', 'Jalan', 'Kode Kota/Kab', 'Uraian Kota/Kabupaten', 'Kode Provinsi', 'Status Penggunaan', 'Status Pengelolaan', 'No PSP', 'Tgl PSP', 'Jumlah KIB', 'SBSK', 'Optimalisasi', 'Tanggal Update'];
    protected $categoryAsset = 10;

    public function __construct()
    {
        $this->model = new AssetRumahNegara();
