...
namespace App\Http\Controllers\Admin\Asset\TetapLainnya;
...
class TetapLainnyaController extends AssetController
{

    private $route = 'admin.asset.tetaplainnya';
    private $title = 'Asset Tetap Lainnya';
    ...
    protected $categoryAsset = 14;

    public function __construct()
    {
        $this->model = new AssetTetapLainnya();
