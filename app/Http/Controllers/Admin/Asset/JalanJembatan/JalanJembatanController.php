...
namespace App\Http\Controllers\Admin\Asset\JalanJembatan;
...
class JalanJembatanController extends AssetController
{

    private $route = 'admin.asset.jalanjembatan';
    private $title = 'Jalan Jembatan';
    public $tableHeader = ['Kode Barang', 'NUP', 'Kode Satker', 'Nama Satker', 'KIB', 'Nama Barang', 'Kondisi', 'Merk/Tipe', 'Tgl Perolehan', 'Tgl Rekam Pertama', 'Nilai Perolehan Pertama', 'Nilai Mutasi', 'Nilai Perolehan', 'Nilai Penyusutan', 'Nilai Buku', 'Kuantitas', 'Luas Bangunan', 'Luas Dasar', 'Jml Foto', 'Status Penggunaan', 'Status Pengelolaan', 'No PSP', 'Tgl PSP', 'Tanggal Update'];
    protected $categoryAsset = 11;

    public function __construct()
    {
        $this->model = new AssetJalanJembatan();
