...
namespace App\Http\Controllers\Admin\Asset\Tanah;
...
class TanahController extends AssetController
{
    private $route = 'admin.asset.tanah';
    private $title = 'Tanah';
    public $tableHeader = ["Kode Barang", "NUP", "Kode Satker", "Nama Satker", "KIB", "Nama Barang", "Kondisi", "Jenis Dokumen", "Kepemilikan ", "Jenis Sertifikat", "Merk/Tipe", "Tgl Perolehan", "Tgl Rekam Pertama", "Nilai Perolehan Pertama", "Nilai Mutasi", "Nilai Perolehan", "Nilai Penyusutan", "Nilai Buku", "Kuantitas(m2)", "Luas Tanah Seluruhnya", "Luas Tanah Untuk Bangunan", "Luas tanah Untuk Sarana Lingkungan", "Luas Lahan Kosong", "Jml Foto", "Status Penggunaan", "Status Pengelolaan", "No. PSP", "Tgl PSP", "Alamat", "RT/RW", "Kelurahan/Desa", "Kecamatan", "Kota/Kabupaten", "Kode Kab/Kota", "Provinsi", "Kode Provinsi", "Kode Pos", "Alamat Lainnya", "Jumlah KIB", "SBSK", "Optimalisasi", 'Tanggal Update'];
    protected $categoryAsset = 3;

    public function __construct()
    {
        $this->model = new AssetTanah();
    ...
    public function index()
    {
        ...
        $data['importSlug'] = 'tanah';

        $data['filter'] = $this->generalFilter();
        $data['baseFilter'] = array_merge($this->baseFilter, ['sertifikat' => 'sertifikat']);
