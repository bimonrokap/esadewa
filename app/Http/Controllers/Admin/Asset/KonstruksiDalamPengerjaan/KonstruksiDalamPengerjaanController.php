...
namespace App\Http\Controllers\Admin\Asset\KonstruksiDalamPengerjaan;
...
class KonstruksiDalamPengerjaanController extends AssetController
{

    private $route = 'admin.asset.konstruksidalampengerjaan';
    private $title = 'Asset Konstruksi Dalam Pengerjaan';
    public $tableHeader = ['Kode Barang', 'NUP', 'Kode Satker', 'Nama Satker', 'KIB', 'Nama Barang', 'Kondisi', 'Merk/Tipe', 'Tgl Perolehan', 'Nilai Perolehan Pertama', 'Nilai Mutasi', 'Nilai Perolehan', 'Nilai Penyusutan', 'Nilai Buku', 'Kuantitas', 'Jml Foto', 'Status Penggunaan', 'Status Pengelolaan', 'No PSP', 'Tgl PSP', 'Tanggal Update'];
    protected $categoryAsset = 17;

    public function __construct()
    {
        $this->model = new AssetKonstruksiDalamPengerjaan();
