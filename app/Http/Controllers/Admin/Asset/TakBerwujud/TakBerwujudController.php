...
namespace App\Http\Controllers\Admin\Asset\TakBerwujud;
...
class TakBerwujudController extends AssetController
{

    private $route = 'admin.asset.takberwujud';
    private $title = 'Asset Tak Berwujud';
    public $tableHeader = ['Kode Barang', 'NUP', 'Kode Satker', 'Nama Satker', 'Nama Barang', 'KIB', 'Kondisi', 'Merk/Tipe', 'Tgl Perolehan', 'Tgl Rekam Pertama', 'Nilai Perolehan Pertama', 'Nilai Mutasi', 'Nilai Perolehan', 'Nilai Penyusutan', 'Nilai Buku', 'Kuantitas', 'Jml Foto', 'Status Penggunaan', 'Status Pengelolaan', 'No PSP', 'Tgl PSP', 'Tanggal Update'];
    protected $categoryAsset = 15;

    public function __construct()
    {
        $this->model = new AssetTakBerwujud();
